...
DATA_PATH = os.path.join(BASE_DIR, "data", "raw", "regression", "db9f62a1c5d2e84b.csv")
TARGET = "price"
DATASET_ID = "db9f62a1c5d2e84b"
OUTPUT_DIR = os.path.join(BASE_DIR, "models", "preprocessors","regression")
DATA_OUTPUT_DIR = os.path.join(BASE_DIR, "data", "preprocessed","regression")
...
# 2. RUN PIPELINE
print("Running Regression Preprocessing Pipeline...")
